...
//get the users email address - useremail (string)
//get the users level - userlevel (string)
//get users hours of study - userhours (number)
// Validate the user's input
// Check if the user has selected a level - check a level has been selected, check against the allowed levels,
// Check if the user has provided an email address - check a email is present, is it valid?, does it have an @
